...
const ProductCardLarge = ({
  ...
  return (
    <div className=" rounded-md shadow-lg w-[500px] h-[225px] flex items-center justify-center  mb-3 ml-3">
      <figure className=" group relative  w-[250px] h-[200px]  rounded-md  flex items-center justify-center transition-all delay-300 ease-in-out overflow-hidden">
        <Link href={`shop/${id}`}>
          <Image
            className="object-fill cursor-pointer w-[250px] h-[300px] hover:scale-125 transition-all delay-75 ease-in-out"
            src={previewImage}
            alt={productName}
            width={250}
            height={300}
        ...
        <div className="group-hover:bottom-11 absolute -bottom-10 flex justify-between items-center  w-[125px] transition-all delay-100 ease-in-out">
          <div className="text-white cursor-pointer bg-accent  w-10 h-10 rounded-md flex justify-center items-center text-[25px] transition-all delay-200 ease-in-out  hover:text-accent hover:border-accent hover:bg-transparent hover:border-2">
            <BsSuitHeart />
          </div>
          <div className="text-white cursor-pointer bg-accent  w-10 h-10 rounded-md flex justify-center items-center text-[25px] transition-all delay-200 ease-in-out  hover:text-accent hover:border-accent hover:bg-transparent hover:border-2">
            <BsCart3 />
